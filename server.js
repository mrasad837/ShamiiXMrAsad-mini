...
const BOT_NAME = process.env.BOT_NAME || "𝗦𝗛𝗔𝗠𝗜𝗜 𝗫 𝗠𝗥𝗔𝗦𝗔𝗗 𝗠𝗗 𝗠𝗜𝗡𝗜";
const OWNER_NAME = process.env.OWNER_NAME || "𝗦𝗛𝗔𝗠𝗜𝗜 𝗫 𝗠𝗥𝗔𝗦𝗔𝗗";

const MENU_IMAGE_URL = process.env.MENU_IMAGE_URL || "https://i.ibb.co/YF4N7X4s/jawadmd.jpg";
...
const AUTO_STATUS_MSG = process.env.AUTO_STATUS_MSG || "YOUR STATUS HAS BEEN SEEN BY 𝗦𝗛𝗔𝗠𝗜𝗜 𝗫 𝗠𝗥𝗔𝗦𝗔𝗗 𝗠𝗗🫶🏻";
const DEV = process.env.DEV || 'SHAMIIxMRASAD';
            ...
            case 'menu1':
                ...
                await conn.sendMessage(from, {
                    ...
                    forwardedNewsletterMessageInfo: {
                        newsletterJid: "120363428310461520@newsletter",
                        newsletterName: "𝗦𝗛𝗔𝗠𝗜𝗜 𝗫 𝗠𝗥𝗔𝗦𝗔𝗗 𝗠𝗗 𝗠𝗜𝗡𝗜",
                        serverMessageId: 200
                    },
                        externalAdReply: {
                            title: "📃 𝗦𝗛𝗔𝗠𝗜𝗜 𝗫 𝗠𝗥𝗔𝗦𝗔𝗗 𝗠𝗗 𝗠𝗜𝗡𝗜 Command Menu",
